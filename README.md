...
```bash
npm install @stdlib/napi-create-uint32
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/napi-create-uint32.svg
[npm-url]: https://npmjs.org/package/@stdlib/napi-create-uint32

[test-image]: https://github.com/stdlib-js/napi-create-uint32/actions/workflows/test.yml/badge.svg?branch=v0.0.2
[test-url]: https://github.com/stdlib-js/napi-create-uint32/actions/workflows/test.yml?query=branch:v0.0.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/napi-create-uint32/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/napi-create-uint32?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/napi-create-uint32.svg
[dependencies-url]: https://david-dm.org/stdlib-js/napi-create-uint32/main
...
[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/napi-create-uint32/main/LICENSE
